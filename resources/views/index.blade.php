...
@section('title', 'Hello my friend')


<!-- Welcome -->
@section('welcome')
<div class="md:w-3/5">
    <h2 class="text-gray-100 text-3xl font-bold text-center sm:text-center md:text-left">Hello my friend</h2>

    <p class="text-gray-400 tracking-wide lg:w-full mt-4 text-justify">
        Hi I am zulkifli, Web Developer, Lorem ipsum, dolor sit amet consectetur adipisicing elit. Illum in sed non alias, fugiat, commodi nemo ut fugit corrupti dolorem sequi ex veniam consequuntur id, maiores beatae ipsa omnis aliquam? Lorem ipsum
    </p>

    <div class="flex justify-center sm:justify-center md:justify-start -ml-3 mt-6">
...
<div class="lg:mt-4 md:w-2/5">
    <div class="flex items-center justify-center">
        <div class="hidden sm:hidden md:block max-w-lg">
            <img class="w-40 h-40 object-cover object-center rounded-full" src="/img/profil.jpg" alt="">
        </div>
    </div>
</div>
<!-- End welcome -->
...
<div class="p-4 lg:w-1/3">
    <div class="h-full bg-white bg-opacity-90 px-8 pt-8 p-6 tracking-wide rounded-lg shadow-sm overflow-hidden relative">
        ...
        <div class="flex -m-1">
            ...
            <a href="{{ route('tags.all', $tag->slug) }}" class="text-gray-500 mb-4 text-sm bg-gray-100 rounded p-1 m-1 transition duration-150 hover:text-gray-500 hover:bg-gray-200">
                {{ $tag->name }}
            </a>
            @endforeach
        </div>
